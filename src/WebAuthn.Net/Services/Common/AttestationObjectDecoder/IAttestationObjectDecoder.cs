...
{
    /// <summary>
    ///     Decodes the <a href="https://www.w3.org/TR/webauthn-3/#attestation-object">attestationObject</a> from binary representation to a typed format for further processing.
    /// </summary>
    /// <param name="attestationObject">Binary representation of the <a href="https://www.w3.org/TR/webauthn-3/#attestation-object">attestationObject</a>.</param>
