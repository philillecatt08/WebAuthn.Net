...
{
    /// <summary>
    ///     Bit 0: <a href="https://www.w3.org/TR/webauthn-3/#concept-user-present">User Present</a> (UP) result
    /// </summary>
    UserPresent = 1 << 0,
    ...
    /// <summary>
    ///     Bit 2: <a href="https://www.w3.org/TR/webauthn-3/#concept-user-verified">User Verified</a> (UV) result
    /// </summary>
    UserVerified = 1 << 2,

    /// <summary>
    ///     Bit 3: <a href="https://www.w3.org/TR/webauthn-3/#backup-eligibility">Backup Eligibility</a> (BE)
    /// </summary>
    BackupEligibility = 1 << 3,

    /// <summary>
    ///     Bit 4: <a href="https://www.w3.org/TR/webauthn-3/#backup-state">Backup State</a> (BS)
    /// </summary>
    BackupState = 1 << 4,
