...
{
    /// <summary>
    ///     Decodes the <a href="https://www.w3.org/TR/webauthn-3/#authenticator-data">authenticator data</a> from binary representation to a typed format for further processing.
    /// </summary>
    /// <param name="rawAuthData">Binary representation of the <a href="https://www.w3.org/TR/webauthn-3/#authenticator-data">authenticator data</a>.</param>
