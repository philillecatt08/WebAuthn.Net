...
{
    /// <summary>
    ///     Asynchronously verifies the <a href="https://www.w3.org/TR/webauthn-3/#sctn-none-attestation">None attestation statement</a>.
    /// </summary>
    /// <param name="context">The context in which the WebAuthn operation is performed.</param>
    /// <param name="attStmt">Decoded <a href="https://www.w3.org/TR/webauthn-3/#sctn-none-attestation">None attestation statement</a>.</param>
