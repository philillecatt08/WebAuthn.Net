...
{
    /// <summary>
    ///     Asynchronously verifies the <a href="https://www.w3.org/TR/webauthn-3/#attestation-statement">attestation statement</a>.
    /// </summary>
    /// <param name="context">The context in which the WebAuthn operation is performed.</param>
    /// <param name="fmt">
    ///     <a href="https://www.w3.org/TR/webauthn-3/#attestation-statement-format-identifier">Attestation statement format identifier</a>. Determines how the <paramref name="attStmt" /> will be interpreted.
    /// </param>
    /// <param name="attStmt">Typed representation of the <a href="https://www.w3.org/TR/webauthn-3/#attestation-statement">attestation statement</a>.</param>
