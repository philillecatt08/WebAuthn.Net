...
/// <summary>
///     Decoded <a href="https://www.w3.org/TR/webauthn-3/#sctn-fido-u2f-attestation">FIDO U2F attestation statement</a>.
/// </summary>
public class FidoU2FAttestationStatement : AbstractAttestationStatement
{
    ...
    /// </summary>
    /// <param name="sig">The <a href="https://www.w3.org/TR/webauthn-3/#attestation-signature">attestation signature</a>. The signature was calculated over the (raw) U2F registration response message [FIDO-U2F-Message-Formats] received by the client from the authenticator.</param>
    ...
    /// <summary>
    ///     The <a href="https://www.w3.org/TR/webauthn-3/#attestation-signature">attestation signature</a>. The signature was calculated over the (raw) U2F registration response message [FIDO-U2F-Message-Formats] received by the client from the authenticator.
    /// </summary>
    public byte[] Sig { get; }
