...
{
    /// <summary>
    ///     Decodes <a href="https://www.w3.org/TR/webauthn-3/#sctn-android-key-attestation">Android Key attestation statement</a> from <see cref="CborMap" /> into <see cref="AndroidKeyAttestationStatement" />.
    /// </summary>
    /// <param name="attStmt">
    ///     CBOR representation of <a href="https://www.w3.org/TR/webauthn-3/#sctn-android-key-attestation">Android Key attestation statement</a>.
    /// </param>
