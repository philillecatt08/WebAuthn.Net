...
{
    /// <summary>
    ///     Decodes <a href="https://www.w3.org/TR/webauthn-3/#sctn-fido-u2f-attestation">FIDO U2F attestation statement</a> from <see cref="CborMap" /> into <see cref="FidoU2FAttestationStatement" />.
    /// </summary>
    /// <param name="attStmt">CBOR representation of <a href="https://www.w3.org/TR/webauthn-3/#sctn-fido-u2f-attestation">FIDO U2F attestation statement</a>.</param>
