...
{
    /// <summary>
    ///     Decodes the <a href="https://www.w3.org/TR/webauthn-3/#attestation-statement">attestation statement</a> from CBOR into a typed one for further work.
    /// </summary>
    /// <param name="attStmt">CBOR representation of the attestation statement.</param>
    /// <param name="attestationStatementFormat">The value of "fmt" obtained from the <a href="https://www.w3.org/TR/webauthn-3/#fig-attStructs">attestationObject</a>. Determines how the <paramref name="attStmt" /> will be interpreted.</param>
