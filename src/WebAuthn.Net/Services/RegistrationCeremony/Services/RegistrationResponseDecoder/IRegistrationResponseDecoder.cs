...
{
    /// <summary>
    ///     Decodes <see cref="RegistrationResponseJSON" /> (<a href="https://www.w3.org/TR/webauthn-3/#iface-pkcredential">PublicKeyCredential</a>) from from a model suitable for JSON serialization into a typed representation for further work.
    /// </summary>
    /// <param name="registrationResponse"><a href="https://www.w3.org/TR/webauthn-3/#iface-pkcredential">PublicKeyCredential</a> model, suitable for serialization into JSON.</param>
