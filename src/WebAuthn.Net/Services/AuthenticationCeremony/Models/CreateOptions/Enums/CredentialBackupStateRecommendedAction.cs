...
public enum CredentialBackupStateRecommendedAction
{
    ...
    ///     <para>
    ///         When the <a href="https://www.w3.org/TR/webauthn-3/#authdata-flags-bs">BS</a> <a href="https://www.w3.org/TR/webauthn-3/#authdata-flags">flag</a> changes from 0 to 1, the <a href="https://www.w3.org/TR/webauthn-3/#authenticator">authenticator</a> is signaling that the
    ///         <a href="https://www.w3.org/TR/credential-management-1/#concept-credential">credential</a> is backed up and is protected from single device loss.
    ///     </para>
    ///     <para>The <a href="https://www.w3.org/TR/webauthn-3/#relying-party">Relying Party</a> MAY choose to prompt the user to upgrade their account security and remove their password.</para>
    /// </summary>
    ...
    ///     <para>
    ///         When the <a href="https://www.w3.org/TR/webauthn-3/#authdata-flags-bs">BS</a> <a href="https://www.w3.org/TR/webauthn-3/#authdata-flags">flag</a> changes from 1 to 0, the <a href="https://www.w3.org/TR/webauthn-3/#authenticator">authenticator</a> is signaling that the
    ///         <a href="https://www.w3.org/TR/credential-management-1/#concept-credential">credential</a> is no longer backed up, and no longer protected from single device loss. This could be the result of the user actions, such as disabling the backup service, or errors, such as
    ///         issues with the backup service.
    ///     </para>
    ///     <para>
    ///         When this transition occurs, the <a href="https://www.w3.org/TR/webauthn-3/#relying-party">Relying Party</a> SHOULD guide the user through a process to validate their other authentication factors. If the user does not have another credential for their account, they
    ///         SHOULD be guided through adding an additional credential to ensure they do not lose access to their account. For example, the user could be prompted to set up an additional <a href="https://www.w3.org/TR/webauthn-3/#authenticator">authenticator</a>, such as a
    ///         <a href="https://www.w3.org/TR/webauthn-3/#roaming-authenticators">roaming authenticator</a> or an <a href="https://www.w3.org/TR/webauthn-3/#authenticator">authenticator</a> that is capable of
    ///         <a href="https://www.w3.org/TR/webauthn-3/#multi-device-credential">multi-device credentials</a>.
    ///     </para>
    /// </summary>
