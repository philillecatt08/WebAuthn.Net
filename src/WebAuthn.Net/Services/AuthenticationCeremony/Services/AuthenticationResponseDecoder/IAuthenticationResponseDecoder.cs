...
{
    /// <summary>
    ///     Decodes <see cref="AuthenticationResponseJSON" /> (<a href="https://www.w3.org/TR/webauthn-3/#iface-pkcredential">PublicKeyCredential</a>) from a model suitable for JSON serialization into a typed representation suitable for further work.
    /// </summary>
    /// <param name="authenticationResponse"><a href="https://www.w3.org/TR/webauthn-3/#iface-pkcredential">PublicKeyCredential</a> model, suitable for serialization into JSON.</param>
